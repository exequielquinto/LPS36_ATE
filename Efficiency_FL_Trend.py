...
load=(0.255,0.255,0.255,0.255,0.255,0.255,0.255,0.255,0.255,0.255,0.255)   #error seems to be coming from 0.2 or 0.1,make it 0.101 and 0.201
...
def measure():
    ...
    time.sleep(0.5)                              
    Iin = float(daq.read())
    temp['B_Iin'] = Iin*1000          #Amp 1.002 for shunt calibration
...
for step in steps:
    ...
    time.sleep(120)   # Delay in seconds before capturing results
    temp = {}
    #measure()
    try:
        measure()
